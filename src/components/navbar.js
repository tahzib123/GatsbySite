        ...
        <div className = {navbarStyles.container}>
            ...
            <nav>
                <ul className = {navbarStyles.ulStyle}>
                    ...
                    <li className = {navbarStyles.navigationel}><Link to = "/suggestions" state = {{array: productArray}} className = {navbarStyles.links} activeClassName={navbarStyles.active}>Suggested</Link></li>
                </ul>
            </nav>
        </div>
    )
